...
```ts
import { createShikiTransformer } from "@unifast/plugin-shiki";
```
...
import { createShikiTransformer } from "@unifast/plugin-shiki";
import type { HastRoot } from "@unifast/plugin-shiki";
...
```ts
import { compile } from "@unifast/node";
import { createShikiTransformer, hastToHtml } from "@unifast/plugin-shiki";
import type { HastRoot } from "@unifast/plugin-shiki";
