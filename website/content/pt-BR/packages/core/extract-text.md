---
title: "extractText()"
description: "Extrai recursivamente todo o conteúdo textual de um nó HAST."
---
...
| `value` | `string` | — | Conteúdo textual (para o tipo `"text"`) |

## Retorna

`string` — Todo o conteúdo textual concatenado a partir do nó e de seus descendentes.
...
### Extrair de um elemento simples
...
### Extrair de elementos aninhados
